...
| **ignore_folders**  | Comma-separated list of folder names to ignore during resource scanning. Files whose paths contain any of these folders will be skipped. If not provided or empty, the tool will use patterns from `.gitignore` files in your project instead. | `"build"`                 | Yes      | `"build,temp,cache"`                                                 |
